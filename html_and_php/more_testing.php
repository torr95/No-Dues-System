      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a class="page-scroll" href="#fine">Check</a></li>
...
<div class="container">
 ...
 <div class="container">
  ...
  <button type="button" class="btn btn-info" data-toggle="collapse" data-target="#demo">Profile</button>
  
</div>

     
       <hr>
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" id="demo" class="collapse">
...
<div class="container">
 <hr>
    <h3 id="fine">Check Dues</h3>
    <hr>
    
    <div class="row">
        <div class="panel panel-primary filterable">
            <div class="panel-heading">
                <h3 class="panel-title">No Dues System</h3>
            ...
            <table class="table">
                <thead>
                    <tr class="filters">
                        ...
                        <th><input type="text" class="form-control" placeholder="Dues" disabled></th>
                    </tr>
                </thead>
                <tbody>
                <?php $query = "SELECT * FROM users where department ='IT'"; //You don't need a ; like you do in SQL
...
$count = 1;
 ...
 while($row = mysql_fetch_array($result)){   //Creates a loop to loop through results
                    echo "<tr>
                        ...
                        <td>"; if ( $row['total']=='0'){echo "<p class='bg-success'>Dues Cleared</p>";}else {echo" <p class='bg-danger'>Dues Not Cleared</p>";};echo "</td>                    
                    </tr>";
                    $count++;}
                    ?>
