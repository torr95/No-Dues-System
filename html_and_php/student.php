        ...
        <div class="panel panel-primary filterable">
            ...
            <table class="table">
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td><a href="library_fine.php">Library Fine</a></td>
                        <td><?php $fine=getuserfield2('fine');
                        echo $fine."/-";
                        $ae=$ae+$fine;?></td>
                    ...
                    <tr>
                        <td>2</td>
                        <td><a href="sports_fine.php">Sports Fine</a></td>
                        <td><?php $fine=getuserfield3('fine');
                        echo $fine."/-";
                        $ae=$ae+$fine;?></td>
                    ...
                    <tr>
                        <td>3</td>
                        <td><a href="mess_fine.php">Mess Fine</a></td>
                        <td><?php $fine=getuserfield4('fine');
                        echo $fine."/-";
                        $ae=$ae+$fine;?></td>
                    ...
                    <tr>
                        <td>4</td>
                        <td><a href="misc_fine.php">Misc Fine</a></td>
                        <td><?php $fine=getuserfield5('fine');
                        echo $fine."/-";
                        $ae=$ae+$fine;?></td>
...
<div class="container">
  <a href="testing.php" class="btn btn-primary" style="float: right">Pay Online</a>
</div>
<br>
<br>
<br>
